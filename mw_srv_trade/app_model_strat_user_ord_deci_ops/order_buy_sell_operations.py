...
from mw_srv_trade.app_common_ops.app_common_trade_constants import AUTO_INPUTS_FILE
from mw_srv_trade.app_common_ops.inst_trade_order_qty_operations import multi_order_qty_normal_original
...
def user_position_enter(inst_order_last_record, inst_record, user_record, user_session):
    ...
    if env == 'prod':
        trading_symbol = inst_order_last_record.inst_option_entry_type
