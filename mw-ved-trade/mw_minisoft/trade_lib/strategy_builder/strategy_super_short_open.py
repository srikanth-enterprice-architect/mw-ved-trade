...
def day_open_str_data_builder(instrument_history_data, auto_inputs, instrument_name):
    ...
    #default_time_frame.sort_values(by='date')
    #df_bk_one_5min_data.sort_values(by='date')
    return pd.merge_asof(default_time_frame.sort_values(by='date'), df_bk_one_5min_data, on="date")
